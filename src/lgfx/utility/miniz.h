...
#include <stdio.h>
#define MZ_FILE size_t

struct ffs_stat_struct
{
    char stat;
};
...
#endif
#if defined(ARDUINO_ARCH_ESP32)
MINIZ_EXPORT mz_bool mz_zip_reader_init_esp_file(mz_zip_archive *pZip, MZ_FILE *pFile, mz_uint64 archive_size, mz_uint flags);
#endif
